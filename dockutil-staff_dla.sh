...
$DOCKUTIL --add /Applications/BusyCal.app --after Mail --no-restart
$DOCKUTIL --add /Applications/Microsoft\ Office\ 2011/Microsoft\ Word.app/ --after BusyCal --no-restart
